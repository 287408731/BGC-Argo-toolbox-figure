...
knitr::include_graphics("/Users/yibinhuang/Desktop/figure_demo/tutorial.jpg")
```
...
```{r echo=FALSE, fig.cap="", out.width = '60%'}
knitr::include_graphics("/Users/yibinhuang/Desktop/figure_demo/figures/profile_id.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '60%'}
knitr::include_graphics("/Users/yibinhuang/Desktop/figure_demo/figures/date.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '60%'}
knitr::include_graphics("/Users/yibinhuang/Desktop/figure_demo/figures/track_excercise_1.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '60%'}
knitr::include_graphics("/Users/yibinhuang/Desktop/figure_demo/figures/profile_1_excercise_1.jpg")
```
...
```{r echo=FALSE, fig.cap="", out.width = '60%'}
knitr::include_graphics("/Users/yibinhuang/Desktop/figure_demo/figures/profile_2_excercise_1.jpg")
```
...
```{r echo=FALSE, fig.cap="", out.width = '60%'}
knitr::include_graphics("/Users/yibinhuang/Desktop/figure_demo/figures/section_1_excercise_1.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '60%'}
knitr::include_graphics("/Users/yibinhuang/Desktop/figure_demo/figures/section_2_excercise_1.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '60%'}
knitr::include_graphics("/Users/yibinhuang/Desktop/figure_demo/figures/track_excercise_2.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '60%'}
knitr::include_graphics("/Users/yibinhuang/Desktop/figure_demo/figures/profile_1_excercise_2.jpg")
```
...
```{r echo=FALSE, fig.cap="", out.width = '60%'}
knitr::include_graphics("/Users/yibinhuang/Desktop/figure_demo/figures/profile_2_excercise_2.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '60%'}
knitr::include_graphics("/Users/yibinhuang/Desktop/figure_demo/figures/track_excercise_3.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '60%'}
knitr::include_graphics("/Users/yibinhuang/Desktop/figure_demo/figures/profile_1_excercise_3.jpg")
```
...
```{r echo=FALSE, fig.cap="", out.width = '60%'}
knitr::include_graphics("/Users/yibinhuang/Desktop/figure_demo/figures/profile_2_excercise_3.jpg")
```
...
```{r echo=FALSE, fig.cap="", out.width = '60%'}
knitr::include_graphics("/Users/yibinhuang/Desktop/figure_demo/figures/section_1_excercise_3.png")
```

```{r echo=FALSE, fig.cap="", out.width = '60%'}
knitr::include_graphics("/Users/yibinhuang/Desktop/figure_demo/figures/section_2_excercise_3.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '60%'}
knitr::include_graphics("/Users/yibinhuang/Desktop/figure_demo/figures/timeseries_1_excercise_3.png")
```
```{r echo=FALSE, fig.cap="", out.width = '60%'}
knitr::include_graphics("/Users/yibinhuang/Desktop/figure_demo/figures/timeseries_2_excercise_3.png")
```
